                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-2">
                            ...
                            <input style="text-transform:uppercase" placeholder="Driver's Full Name" class="form-control @error('name') is-invalid @enderror" type="text" maxlength="255" name="name" id="name" value="{{ old('name', $d->name) }}" required>
